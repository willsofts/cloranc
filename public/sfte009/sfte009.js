...
$(function(){
	...
	try { startApplication("sfte009"); }catch(ex) { console.warn("error",ex);  }
	initialApplication();
...
function search(aform) {
	...
	startWaiting();
	jQuery.ajax({
		url: getApiUrl()+"/api/sfte009/search",
...
function saveForm(aform) {
	...
	startWaiting();
	jQuery.ajax({
		url: getApiUrl()+"/api/sfte009/insert",
		data: formdata.jsondata,
		headers : formdata.headers,
		type: "POST",
		dataType: "html",
...
function updateForm(aform) {
	...
	startWaiting();
	jQuery.ajax({
		url: getApiUrl()+"/api/sfte009/update",
		data: formdata.jsondata,
		headers : formdata.headers,
		type: "POST",
		dataType: "html",
...
function submitRetrieve(src,domainid) {
	...
	startWaiting();
	jQuery.ajax({
		url: getApiUrl()+"/api/sfte009/retrieval",
		data: formdata.jsondata,
		headers: formdata.headers,
		type: "POST",
		dataType: "html",
...
function deleteRecord(fsParams) {
	...
	startWaiting();
	jQuery.ajax({
		url: getApiUrl()+"/api/sfte009/remove",
		data: formdata.jsondata,
		headers: formdata.headers,
		type: "POST",
		dataType: "html",
