...
$(function(){
	...
	try { startApplication("sfte004"); }catch(ex) { console.warn("error",ex);  }
	initialApplication();
...
function search(aform) {
	...
	startWaiting();
	jQuery.ajax({
		url: getApiUrl()+"/api/sfte004/search",
...
function saveForm(aform) {
	...
	startWaiting();
	jQuery.ajax({
		url: getApiUrl()+"/api/sfte004/insert",
		data: formdata.jsondata,
		headers : formdata.headers,
		type: "POST",
		dataType: "html",
...
function updateForm(aform) {
	...
	startWaiting();
	jQuery.ajax({
		url: getApiUrl()+"/api/sfte004/update",
		data: formdata.jsondata,
		headers : formdata.headers,
		type: "POST",
		dataType: "html",
...
function submitRetrieve(src,roleid) {
	...
	startWaiting();
	jQuery.ajax({
		url: getApiUrl()+"/api/sfte004/retrieval",
		data: formdata.jsondata,
		headers: formdata.headers,
		type: "POST",
		dataType: "html",
...
function deleteRecord(fsParams) {
	...
	startWaiting();
	jQuery.ajax({
		url: getApiUrl()+"/api/sfte004/remove",
		data: formdata.jsondata,
		headers: formdata.headers,
		type: "POST",
		dataType: "html",
