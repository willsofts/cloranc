...
$(function(){
	...
	try { startApplication("sfte011"); }catch(ex) { console.warn("error",ex);  }
	initialApplication();
...
function search(aform) {
	...
	startWaiting();
	jQuery.ajax({
		url: getApiUrl()+"/api/sfte011/search",
...
function saveForm(aform) {
	...
	startWaiting();
	jQuery.ajax({
		url: getApiUrl()+"/api/sfte011/insert",
		data: formdata.jsondata,
		headers : formdata.headers,
		type: "POST",
		dataType: "html",
...
function updateForm(aform) {
	...
	startWaiting();
	jQuery.ajax({
		url: getApiUrl()+"/api/sfte011/update",
		data: formdata.jsondata,
		headers : formdata.headers,
		type: "POST",
		dataType: "html",
...
function submitRetrieve(src,reservenum) {
	...
	startWaiting();
	jQuery.ajax({
		url: getApiUrl()+"/api/sfte011/retrieval",
		data: formdata.jsondata,
		headers: formdata.headers,
		type: "POST",
		dataType: "html",
...
function deleteRecord(fsParams) {
	...
	startWaiting();
	jQuery.ajax({
		url: getApiUrl()+"/api/sfte011/remove",
		data: formdata.jsondata,
		headers: formdata.headers,
		type: "POST",
		dataType: "html",
