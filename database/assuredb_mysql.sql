...
CREATE TABLE IF NOT EXISTS `tattachfile` (
  ...
  `attachdir` VARCHAR(350) DEFAULT NULL,
  `attachkey` VARCHAR(350) DEFAULT NULL,
...
INSERT INTO `tconfig` (`category`, `colname`, `colvalue`, `colflag`, `seqno`, `remarks`) VALUES
  ...
  ('CONFIGMAIL', 'MAIL_SECURE', 'true', NULL, 0, NULL),
...
INSERT INTO `tprog` (`product`, `programid`, `progname`, `prognameth`, `progtype`, `appstype`, `description`, `parameters`, `progsystem`, `iconfile`, `iconstyle`, `shortname`, `shortnameth`, `progpath`, `newflag`, `openmethod`, `editdate`, `edittime`, `edituser`) VALUES
	('PROMPT', 'sfte001', 'Program Information', 'ข้อมูลโปรแกรม', 'F', 'W', 'Program Information', '', 'A', 'sfte001.png', NULL, 'Program', 'โปรแกรม', '/gui/sfte001', NULL, NULL, NULL, NULL, NULL),
	('PROMPT', 'sfte002', 'Group Information', 'กลุ่มผู้ใช้งาน', 'F', 'W', 'Group Information', NULL, 'A', 'sfte002.png', NULL, 'Group', 'กลู่มผู้ใช้', NULL, NULL, NULL, NULL, NULL, NULL),
	('PROMPT', 'sfte003', 'Product Information', 'ข้อมูลผลิตภัณท์', 'F', 'W', 'Product Information', NULL, 'A', 'sfte003.png', NULL, 'Product', 'ผลิตภัณท์', NULL, NULL, NULL, NULL, NULL, NULL),
	('PROMPT', 'sfte004', 'Role Information', 'ข้อมูลบทบาท', 'F', 'W', 'Role Information', NULL, 'A', 'sfte004.png', NULL, 'Role', 'บทบาท', NULL, NULL, NULL, NULL, NULL, NULL),
	('PROMPT', 'sfte005', 'User Information', 'ข้อมูลผู้ใช้', 'F', 'W', 'User Information', NULL, 'A', 'sfte005.png', NULL, 'User', 'ผู้ใช้งาน', NULL, NULL, NULL, NULL, NULL, NULL),
	('PROMPT', 'sfte007', 'User Privilege', 'สิทธิผู้ใช้', 'F', 'W', 'User Privilege', NULL, 'A', 'sfte007.png', NULL, 'Privilege', 'สิทธิผู้ใช้', NULL, NULL, NULL, NULL, NULL, NULL),
	('PROMPT', 'sfte008', 'Menu Administration', 'จัดตั้งระบบเมนู', 'F', 'W', 'Menu Administration', NULL, 'A', 'sfte008.png', NULL, 'Menu', 'ตั้งค่าเมนู', NULL, NULL, NULL, NULL, NULL, NULL),
	('PROMPT', 'sfte009', 'Active Directory', 'ข้อมูลโครงสร้าง', 'F', 'W', 'Active Directory', NULL, 'A', 'sfte009.png', NULL, 'Active Directory', 'โครงสร้าง', NULL, NULL, NULL, NULL, NULL, NULL),
	('PROMPT', 'sfte010', 'Password Policy Setting', 'นโยบายจัดตั้งรหัสผ่าน', 'F', 'W', 'Password Policy Setting', NULL, 'A', 'sfte010.png', NULL, 'Password Policy', 'นโยบายรหัสผ่าน', NULL, NULL, NULL, NULL, NULL, NULL),
	('PROMPT', 'sfte011', 'Password Policy', 'Password Policy', 'F', 'W', 'Password Policy', NULL, 'A', 'sfte011.png', NULL, 'Password Policy', 'Password Policy', NULL, NULL, NULL, NULL, NULL, NULL),
	('PROMPT', 'sfte012', 'Configuration Setting', 'ตั้งค่าเบื้องต้น', 'F', 'W', 'Configuration Setting', NULL, 'A', 'sfte012.png', NULL, 'Configure', 'ตั้งค่าเบื้องต้น', NULL, NULL, NULL, NULL, NULL, NULL),
	('PROMPT', 'sfte013', 'Mail Template Setting', 'ตั้งค่าต้นแบบเมล', 'F', 'W', 'Mail Template Setting', NULL, 'A', 'sfte013.png', NULL, 'Mail Template', 'ตั้งค่าเมล', NULL, NULL, NULL, NULL, NULL, NULL),
	('PROMPT', 'sfte014', 'Label Setting', 'ตั้งค่าป้าย', 'F', 'W', 'Label Setting', NULL, 'A', 'sfte014.png', NULL, 'Label', 'ตั้งค่าป้าย', NULL, NULL, NULL, NULL, NULL, NULL),
	('PROMPT', 'sfte015', 'Message Code', 'ตั้งค่าข้อความ', 'F', 'W', 'Message Code', NULL, 'A', 'sfte015.png', NULL, 'Message', 'ตั้งค่าข้อความ', NULL, NULL, NULL, NULL, NULL, NULL),
	('PROMPT', 'sfte016', 'Account Information', 'ข้อมูลผู้ใช้', 'F', 'W', 'Account', NULL, 'A', 'sfte016.png', NULL, 'User', 'ผู้ใช้งาน', NULL, NULL, NULL, NULL, NULL, NULL),
	('PROMPT', 'sfte017', 'Two Factor Authentication', 'Two Factor Authentication', 'F', 'W', 'Two Factor Authentication', NULL, 'A', 'sfte017.png', NULL, '2Factor', '2Factor', NULL, NULL, NULL, NULL, NULL, NULL),
	('PROMPT', 'sfte018', 'Tenant Setting', 'Tenant Setting', 'F', 'W', 'Tenant', NULL, 'A', 'sfte018.png', NULL, 'Tenant', 'Tenant', NULL, NULL, NULL, NULL, NULL, NULL),
	('PROMPT', 'sfte019', 'Branch Information', 'ข้อมูลสาขา', 'F', 'W', 'Branch Information', NULL, 'A', 'sfte019.png', NULL, 'Branch', 'สาขา', NULL, NULL, NULL, NULL, NULL, NULL),
	('PROMPT', 'sftq001', 'Tracking', 'การตรวจสอบ', 'F', 'W', 'Tracking', NULL, 'A', 'sftq001.png', NULL, 'Tracking', 'ตรวจสอบ', NULL, NULL, NULL, NULL, NULL, NULL),
	...
	('VUE', 'vfte004', 'Role Information', 'ข้อมูลบทบาท', 'F', 'W', 'Role Information', NULL, 'A', 'sfte004.png', NULL, 'Role', 'บทบาท', '/show/vfte004', NULL, NULL, NULL, NULL, NULL),
	('VUE', 'vfte005', 'User Information', 'ข้อมูลผู้ใช้', 'F', 'W', 'User Information', NULL, 'A', 'sfte005.png', NULL, 'User', 'ผู้ใช้งาน', '/show/vfte005', NULL, NULL, NULL, NULL, NULL),
	('VUE', 'vfte007', 'User Privilege', 'สิทธิผู้ใช้', 'F', 'W', 'User Privilege', NULL, 'A', 'sfte007.png', NULL, 'Privilege', 'สิทธิผู้ใช้', '/show/vfte007', NULL, NULL, NULL, NULL, NULL),
	('VUE', 'vfte008', 'Menu Administration', 'ตั้งระบบเมนู', 'F', 'W', 'Menu Administration', NULL, 'A', 'sfte008.png', NULL, 'Menu', 'เมนู', '/show/vfte008', NULL, NULL, NULL, NULL, NULL),
	('VUE', 'vfte009', 'Active Directory', 'ข้อมูลโครงสร้าง', 'F', 'W', 'Active Directory', NULL, 'A', 'sfte009.png', NULL, 'Active Directory', 'โครงสร้าง', '/show/vfte009', NULL, NULL, NULL, NULL, NULL),
	('VUE', 'vfte010', 'Password Policy Setting', 'นโยบายจัดตั้งรหัสผ่าน', 'F', 'W', 'Password Policy Setting', NULL, 'A', 'sfte010.png', NULL, 'Password Policy', 'นโยบายรหัสผ่าน', '/show/vfte010', NULL, NULL, NULL, NULL, NULL),
	('VUE', 'vfte011', 'Password Policy', 'Password Policy', 'F', 'W', 'Password Policy', NULL, 'A', 'sfte011.png', NULL, 'Password Policy', 'Password Policy', '/show/vfte011', NULL, NULL, NULL, NULL, NULL),
	('VUE', 'vfte012', 'Configuration Setting', 'ตั้งค่าเบื้องต้น', 'F', 'W', 'Configuration Setting', NULL, 'A', 'sfte012.png', NULL, 'Configure', 'ตั้งค่าเบื้องต้น', '/show/vfte012', NULL, NULL, NULL, NULL, NULL),
	('VUE', 'vfte013', 'Mail Template Setting', 'ตั้งค่าต้นแบบเมล', 'F', 'W', 'Mail Template Setting', NULL, 'A', 'sfte013.png', NULL, 'Mail Template', 'ตั้งค่าเมล', '/show/vfte013', NULL, NULL, NULL, NULL, NULL),
	('VUE', 'vfte014', 'Label Setting', 'ตั้งค่าป้าย', 'F', 'W', 'Label Setting', NULL, 'A', 'sfte014.png', NULL, 'Label', 'ตั้งค่าป้าย', '/show/vfte014', NULL, NULL, NULL, NULL, NULL),
	('VUE', 'vfte015', 'Message Code', 'ตั้งค่าข้อความ', 'F', 'W', 'Message Code', NULL, 'A', 'sfte015.png', NULL, 'Message', 'ตั้งค่าข้อความ', '/show/vfte015', NULL, NULL, NULL, NULL, NULL),
	('VUE', 'vfte016', 'Account Information', 'ข้อมูลผู้ใช้', 'F', 'W', 'Account Information', NULL, 'A', 'sfte016.png', NULL, 'User', 'ผู้ใช้งาน', '/show/vfte016', NULL, NULL, NULL, NULL, NULL),
	('VUE', 'vfte017', 'Two Factor Authentication', 'Two Factor Authentication', 'F', 'W', 'Two Factor Authentication', NULL, 'A', 'sfte017.png', NULL, '2Factor', '2Factor', '/show/vfte017', NULL, NULL, NULL, NULL, NULL),
	('VUE', 'vfte018', 'Tenant Setting', 'Tenant Setting', 'F', 'W', 'Tenant Setting', NULL, 'A', 'sfte018.png', NULL, 'Tenant', 'Tenant', '/show/vfte018', NULL, NULL, NULL, NULL, NULL),
	('VUE', 'vfte019', 'Branch Information', 'ข้อมูลสาขา', 'F', 'W', 'Branch Information', NULL, 'A', 'sfte019.png', NULL, 'Branch', 'สาขา', '/show/vfte019', NULL, NULL, NULL, NULL, NULL),
	('VUE', 'vftq001', 'Tracking Information', 'การตรวจสอบ', 'F', 'W', 'Tracking Information', NULL, 'A', 'sftq001.png', NULL, 'Tracking', 'ตรวจสอบ', '/show/vftq001', NULL, NULL, NULL, NULL, NULL),
	('VUE', 'vftq003', 'Mail Tracking', 'Mail Tracking', 'F', 'W', 'Mail Tracking', NULL, 'A', 'sftq003.png', NULL, 'Mail Tracking', 'Mail Tracking', '/show/vftq003', NULL, NULL, NULL, NULL, NULL),
	('VUE', 'vftu003', 'API Configuration', 'กำหนดค่า API', 'F', 'W', 'API Configuration', NULL, 'A', 'sftu003.png', NULL, 'API Config', 'กำหนดค่า API', '/show/vftu003', NULL, NULL, NULL, NULL, NULL),
	('VUE', 'vftu004', 'Access Token', 'กำหนด Token', 'F', 'W', 'Access Token', NULL, 'A', 'sftu004.png', NULL, 'Token', 'กำหนด Token', '/show/vftu004', NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `tproggrp` (`groupname`, `programid`, `parameters`, `seqno`) VALUES
	...
	('ADMIN', 'sfte015', NULL, 11),
	('ADMIN', 'sfte016', NULL, 12),
	('ADMIN', 'sfte017', NULL, 13),
	('ADMIN', 'sfte018', NULL, 14),
	('ADMIN', 'sftq001', NULL, 15),
	('ADMIN', 'sftq003', NULL, 16),
	('ADMIN', 'sftu003', NULL, 17),
	('ADMIN', 'sftu004', NULL, 18),
	...
	('TESTER', 'sfte015', NULL, 14),
	('TESTER', 'sfte016', NULL, 15),
	('TESTER', 'sfte017', NULL, 16),
	('TESTER', 'sfte018', NULL, 17),
	('TESTER', 'sfte019', NULL, 18),
	('TESTER', 'sftq001', NULL, 19),
	('TESTER', 'sftq003', NULL, 20),
	('TESTER', 'sftu003', NULL, 21),
	('TESTER', 'sftu004', NULL, 22);
