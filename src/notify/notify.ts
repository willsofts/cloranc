...
import { NOTIFY_USER, NOTIFY_TOKEN, NOTIFY_TOKEN_STYLE, NOTIFY_USER_DEFAULT, NOTIFY_TOKEN_DEFAULT } from "../utils/EnvironmentVariable";
...
class NotifyHandler extends TknOperateHandler {
    ...
    protected override async doExecute(context: KnContextInfo, model: KnModel) : Promise<KnDataTable> {
        ...
        let ds = { username: username, tokenstyle: NOTIFY_TOKEN_STYLE, tokenkey: NOTIFY_TOKEN || (NOTIFY_TOKEN_DEFAULT ? this.getTokenKey(context) : "") };
