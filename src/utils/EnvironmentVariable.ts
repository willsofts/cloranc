...
export const EXPIRE_TIMES = Number.parseInt(config.env("EXPIRE_TIMES","64800000")) || 18*60*60*1000; //18 hours expired
export const EXPIRE_DATES = Number.parseInt(config.env("EXPIRE_DATES","120")) || 120; //120 days expired
export const MAX_FAILURE = Number.parseInt(config.env("MAX_FAILURE","3")) || 3;
export const MAX_WAITTIME = Number.parseInt(config.env("MAX_WAITTIME","180000")) || 180000; //3 minutes (3x60x1000)
...
export const UPLOAD_FILE_SIZE : number = Number.parseInt(config.env("UPLOAD_FILE_SIZE","10485760")) || 10*1024*1024; //10MB
export const UPLOAD_FILE_COUNT : number = Number.parseInt(config.env("UPLOAD_FILE_COUNT","10")) || 10;
export const UPLOAD_FILE_PATH: string = config.env("UPLOAD_FILE_PATH") || os.tmpdir();
...
export const DEFAULT_INVALIDATE_TIMES = Number.parseInt(config.env("DEFAULT_INVALIDATE_TIMES","300000")) || 5*60*1000; //5 minutes expired
export const DEFAULT_ACCOUNT_INVALIDATE_TIMES = Number.parseInt(config.env("DEFAULT_ACCOUNT_INVALIDATE_TIMES","2592000000")) || 30*24*60*60*1000; //30 days expired
export const DEFAULT_ONETIME_LENGTH = Number.parseInt(config.env("DEFAULT_ONETIME_LENGTH","6")) || 6;
...
export const DEFAULT_PASSWORD: string = config.env("DEFAULT_PASSWORD","password");
